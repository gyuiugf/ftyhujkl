...
namespace UnityEngine.InputSystem.HID
{
	public class HID : InputDevice
	{
		...
		public struct HIDDeviceDescriptorBuilder
		{
			...
			{
				this.usagePage = default(UsagePage);
				this.usage = 0;
				m_CurrentReportId = 0;
				m_CurrentReportType = default(HIDReportType);
				m_CurrentReportOffsetInBits = 0;
				m_Elements = null;
				m_Collections = null;
				m_InputReportSize = 0;
		...
		private static readonly ProfilerMarker k_HIDParseDescriptorFallback;
