...
namespace UnityEngine.InputSystem
{
	internal class InputManager
	{
		...
		[CompilerGenerated]
		private sealed class _003CListControlLayouts_003Ed__100 : IEnumerable<string>, IEnumerable, IEnumerator<string>, IEnumerator, IDisposable
		{
			...
			[DebuggerHidden]
			public _003CListControlLayouts_003Ed__100(int _003C_003E1__state)
			{
			}
		...
		private static readonly ProfilerMarker k_InputUpdateProfilerMarker;

		private static readonly ProfilerMarker k_InputTryFindMatchingControllerMarker;

		private static readonly ProfilerMarker k_InputAddDeviceMarker;

		private static readonly ProfilerMarker k_InputRestoreDevicesAfterReloadMarker;

		private static readonly ProfilerMarker k_InputRegisterCustomTypesMarker;

		private static readonly ProfilerMarker k_InputOnBeforeUpdateMarker;

		private static readonly ProfilerMarker k_InputOnAfterUpdateMarker;

		private static readonly ProfilerMarker k_InputOnSettingsChangeMarker;

		private static readonly ProfilerMarker k_InputOnDeviceSettingsChangeMarker;

		private static readonly ProfilerMarker k_InputOnEventMarker;

		private static readonly ProfilerMarker k_InputOnLayoutChangeMarker;

		private static readonly ProfilerMarker k_InputOnDeviceChangeMarker;

		private static readonly ProfilerMarker k_InputOnActionsChangeMarker;
		...
		public InputSettings.ScrollDeltaBehavior scrollDeltaBehavior
		{
			get
			{
				return default(InputSettings.ScrollDeltaBehavior);
			}
			set
			{
			}
		...
		internal InputEventHandledPolicy inputEventHandledPolicy
		{
			get
			{
				return default(InputEventHandledPolicy);
			}
			set
			{
			}
		...
		[IteratorStateMachine(typeof(_003CListControlLayouts_003Ed__100))]
		...
		{
			return default(JsonParser.JsonString);
		}
