...
namespace UnityEngine.InputSystem
{
	...
	public class Keyboard : InputDevice, ITextInputReceiver, IEventPreProcessor
	{
		...
		public KeyControl f13Key => null;

		public KeyControl f14Key => null;

		public KeyControl f15Key => null;

		public KeyControl f16Key => null;

		public KeyControl f17Key => null;

		public KeyControl f18Key => null;

		public KeyControl f19Key => null;

		public KeyControl f20Key => null;

		public KeyControl f21Key => null;

		public KeyControl f22Key => null;

		public KeyControl f23Key => null;

		public KeyControl f24Key => null;

		public KeyControl mediaPlayPause => null;

		public KeyControl mediaRewind => null;

		public KeyControl mediaForward => null;
		...
		bool IEventPreProcessor.PreProcessEvent(InputEventPtr currentEventPtr)
		{
			return false;
		}
	}
