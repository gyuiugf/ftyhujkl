namespace UnityEngine.Rendering.Universal
{
	internal static class ShaderPropertyId
	{
		...
		public static readonly int lastTimeParameters;
		...
		public static readonly int previousViewProjectionNoJitter;

		public static readonly int viewProjectionNoJitter;

		public static readonly int previousViewProjectionNoJitterStereo;

		public static readonly int viewProjectionNoJitterStereo;
		...
		public static readonly int rtHandleScale;
		...
		public static readonly int screenSpaceIrradiance;
	}
}
