...
namespace UnityEngine.Rendering.Universal
{
	...
	internal class ShadowUtility
	{
		...
		internal delegate void CalculateProjectionInfo_000002D1_0024PostfixBurstDelegate(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<int> inShapeStartingEdge, ref NativeArray<bool> inShapeIsClosedArray, ref NativeArray<Vector2> outProjectionInfo);

		internal static class CalculateProjectionInfo_000002D1_0024BurstDirectCall
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void CalculateVertices_000002D2_0024PostfixBurstDelegate(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<Vector2> inEdgeOtherPoints, ref NativeArray<ShadowMeshVertex> outMeshVertices);

		internal static class CalculateVertices_000002D2_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void CalculateTriangles_000002D3_0024PostfixBurstDelegate(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<int> inShapeStartingEdge, ref NativeArray<bool> inShapeIsClosedArray, ref NativeArray<int> outMeshIndices);

		internal static class CalculateTriangles_000002D3_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void CalculateLocalBounds_000002D4_0024PostfixBurstDelegate(ref NativeArray<Vector3> inVertices, out Bounds retBounds);

		internal static class CalculateLocalBounds_000002D4_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void CalculateEdgesFromLines_000002D7_0024PostfixBurstDelegate(ref NativeArray<int> indices, out NativeArray<ShadowEdge> outEdges, out NativeArray<int> outShapeStartingEdge, out NativeArray<bool> outShapeIsClosedArray);

		internal static class CalculateEdgesFromLines_000002D7_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void GetVertexReferenceStats_000002D8_0024PostfixBurstDelegate(ref NativeArray<Vector3> vertices, ref NativeArray<ShadowEdge> edges, int vertexCount, out bool hasReusedVertices, out int newVertexCount, out NativeArray<RemappingInfo> remappingInfo);

		internal static class GetVertexReferenceStats_000002D8_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void CalculateEdgesFromTriangles_000002DA_0024PostfixBurstDelegate(ref NativeArray<Vector3> vertices, ref NativeArray<int> indices, bool duplicatesVertices, out NativeArray<Vector3> newVertices, out NativeArray<ShadowEdge> outEdges, out NativeArray<int> outShapeStartingEdge, out NativeArray<bool> outShapeIsClosedArray);

		internal static class CalculateEdgesFromTriangles_000002DA_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void ReverseWindingOrder_000002DB_0024PostfixBurstDelegate(ref NativeArray<int> inShapeStartingEdge, ref NativeArray<ShadowEdge> inOutSortedEdges);

		internal static class ReverseWindingOrder_000002DB_0024BurstDirectCall
		{
			private static IntPtr Pointer;
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(CalculateProjectionInfo_000002D1_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(CalculateVertices_000002D2_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(CalculateTriangles_000002D3_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(CalculateLocalBounds_000002D4_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(GenerateInteriorMesh_000002D5_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(CalculateEdgesFromLines_000002D7_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(GetVertexReferenceStats_000002D8_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(CalculateEdgesFromTriangles_000002DA_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(ReverseWindingOrder_000002DB_0024PostfixBurstDelegate))]
		...
		[BurstCompile]
		[MonoPInvokeCallback(typeof(ClipEdges_000002DE_0024PostfixBurstDelegate))]
