...
namespace Unity.Burst.Intrinsics
{
	...
	public static class X86
	{
		...
		public static class Avx2
		{
			...
			private unsafe static void EmulatedGather<T, U>(T* dptr, void* base_addr, long* indexPtr, int scale, int n, U* mask) where T : unmanaged where U : unmanaged
			{
			}

			private unsafe static void EmulatedGather<T, U>(T* dptr, void* base_addr, int* indexPtr, int scale, int n, U* mask) where T : unmanaged where U : unmanaged
			{
			}
		...
		public static class Sse4_2
		{
			...
			private unsafe static v128 cmpistrm_emulation<T>(T* a, T* b, int len, int imm8, int allOnes, T allOnesT) where T : unmanaged
			{
				return default(v128);
			}

			private unsafe static v128 cmpestrm_emulation<T>(T* a, int alen, T* b, int blen, int len, int imm8, int allOnes, T allOnesT) where T : unmanaged
			{
				return default(v128);
			}

			private static v128 ComputeStrmOutput<T>(int len, int imm8, T allOnesT, int intRes2) where T : struct
			{
				return default(v128);
			}

			private unsafe static int cmpistri_emulation<T>(T* a, T* b, int len, int imm8, int allOnes, T allOnesT) where T : unmanaged
			{
				return 0;
			}

			private unsafe static int cmpestri_emulation<T>(T* a, int alen, T* b, int blen, int len, int imm8, int allOnes, T allOnesT) where T : unmanaged
			{
				return 0;
			}
			...
			private unsafe static int ComputeStringLength<T>(T* ptr, int max) where T : unmanaged
			{
				return 0;
			}

			private unsafe static int ComputeStrCmpIntRes2<T>(T* a, int alen, T* b, int blen, int len, int imm8, int allOnes) where T : unmanaged
			{
				return 0;
			}
		...
		[MonoPInvokeCallback(typeof(DoSetCSRTrampoline_00000129_0024PostfixBurstDelegate))]
		private static void DoSetCSRTrampoline(int bits)
		{
		}

		[BurstCompile(CompileSynchronously = true)]
		[MonoPInvokeCallback(typeof(DoGetCSRTrampoline_0000012A_0024PostfixBurstDelegate))]
