...
namespace UnityEngine.Purchasing
{
	...
	{
		[CompilerGenerated]
		private sealed class _003CIgnoreExceptions_003Ed__1<T, TException> : IEnumerable<T>, IEnumerable, IEnumerator<T>, IEnumerator, IDisposable where T : notnull where TException : notnull
		{
		...
		public static IEnumerable<T> IgnoreExceptions<T, TException>(this IEnumerable<T> enumerable, Action<TException>? onException = null) where T : notnull where TException : notnull
		{
			return null;
		}
	}
