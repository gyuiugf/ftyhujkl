...
{
	// Token: 0x06000246 RID: 582 RVA: 0x00032AB8 File Offset: 0x00030CB8
	private void Awake()
	{
		if (this != 0)
		{
	...
	// Token: 0x06000247 RID: 583 RVA: 0x00032B68 File Offset: 0x00030D68
	private void OnGUI()
	{
		/*
An exception occurred when decompiling this method (06000247)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void ReporterGUI::OnGUI()
